...
const std::string vertexShaderPath = "VulkanAPI/shaders/vert.spv";
const std::string fragmentShaderPath = "VulkanAPI/shaders/frag.spv";

const std::string MODEL_PATH = "VulkanAPI/models/viking_room.obj";
const std::string TEXTURE_PATH = "VulkanAPI/textures/viking_room.png";
...
private:
    ...
    void createInstance()
    {
        ...
        auto s_extensions = getRequiredExtensions();
        ...
        VKPrint("Available extensions: ")

            for (const auto& extension : extensions)
            {
                VKPrint(extension.extensionName)
            }
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        // mat4          // rotation speed           // rotation axis
        ubo.model = glm::rotate(glm::mat4(1.0f), m_Speed * time * glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        // eye position            // look at position               // up axis
        ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        // vertical field-of-view          // aspect ratio                 // near and far clip
    ...
    void createTextureImage()
    {
        ...
        {
            pixels = stbi_load("VulkanAPI/textures/statue.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
        }
    ...
    void setVertexIndexData(std::vector<Vertex>* Vertices, std::vector<uint32_t>* Indices)
    {
        vertices = *Vertices;
        indices = *Indices;
    }
